...
from vlmmodel_my.model.vision_encoder import build_vision_tower
from vlmmodel_my.model.vision_projector import build_vision_projector
from vlmmodel_my.constants import IGNORE_INDEX, IMAGE_TOKEN_INDEX, \
    DEFAULT_IMAGE_PATCH_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN

# vision_head== vision_encoder + vision_projector

class VisionHead:

    def __init__(self, config):
        super(VisionHead, self).__init__(config)
